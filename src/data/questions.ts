...
export const quizSteps: QuizStep[] = [
  ...
  {
    id: "eje-datos-personas",
    kind: "slider",
    prompt: "¿Dónde te sientes más cómodo?",
    helper: "Mueve el deslizador. No hay respuesta correcta.",
    leftLabel: "Con datos, números y sistemas",
    rightLabel: "Con personas, equipos y conversaciones",
    leftVector: {
      traits: { analitico: 5 },
      interests: { tecnologia: 4, finanzas: 3, operaciones: 3 },
    },
    rightVector: {
      traits: { colaborador: 5, lider: 3 },
      interests: { educacion: 4, comunicacion: 3, innovacion_social: 3 },
    },
  },
  {
    id: "mapa-intereses",
  ...
  },
  {
    id: "logro",
    kind: "cards",
    prompt: "¿Cuál de estos logros te daría más satisfacción?",
    options: [
      {
        id: "rentabilidad",
        label: "Subir la rentabilidad de un negocio",
        icon: "coins",
        vector: { interests: { finanzas: 5, gestion: 2 }, traits: { analitico: 3 } },
      },
      {
        id: "producto",
        label: "Sacar al aire un producto digital",
        icon: "cpu",
        vector: { interests: { tecnologia: 5 }, traits: { ejecutor: 3 } },
      },
      {
        id: "gente",
        label: "Ver crecer a alguien que formaste",
        icon: "graduation",
        vector: { interests: { educacion: 5 }, traits: { colaborador: 3 } },
      },
      {
        id: "comunidad",
        label: "Mejorar la vida de una comunidad",
        icon: "heart",
        vector: { interests: { innovacion_social: 5 }, traits: { lider: 2 } },
      },
    ],
  },
  {
    id: "eje-ritmo",
    kind: "slider",
    prompt: "Tu ritmo ideal de trabajo",
    leftLabel: "Planear a fondo antes de mover un dedo",
    rightLabel: "Probar rápido y corregir sobre la marcha",
    leftVector: {
      traits: { analitico: 4 },
      interests: { gestion: 4, finanzas: 2, salud_trabajo: 2 },
      goals: { profundizar: 3 },
    },
    rightVector: {
      traits: { ejecutor: 4, creativo: 3 },
      interests: { comunicacion: 3, tecnologia: 3 },
      goals: { emprender: 3 },
    },
  },
  {
    id: "horizonte",
    kind: "cards",
    prompt: "En dos años te quieres ver...",
    options: [
      {
        id: "dirigiendo",
        label: "Dirigiendo un área completa",
        icon: "compass",
        vector: { goals: { ascender: 5 }, traits: { lider: 4 }, interests: { gestion: 3 } },
      },
      {
        id: "propio",
        label: "Viviendo de mi propio proyecto",
        icon: "rocket",
        vector: { goals: { emprender: 5 }, traits: { creativo: 3 }, interests: { finanzas: 2 } },
      },
      {
        id: "referente",
        label: "Siendo el referente técnico de mi tema",
        icon: "target",
        vector: { goals: { profundizar: 5 }, traits: { analitico: 4 } },
      },
      {
        id: "nuevo-sector",
        label: "Trabajando en un sector totalmente distinto",
        icon: "refresh",
        vector: { goals: { cambiar_carrera: 5 }, traits: { creativo: 2 } },
      },
    ],
  },
];
